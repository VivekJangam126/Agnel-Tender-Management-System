...
import { queryTenderAI, generateTenderAI, assistTenderDrafting, explainContent } from '../controllers/ai.controller.js';
...
// Generic explanation endpoint - for analyzing text/content
router.post('/explain', requireAuth, aiRateLimiter, explainContent);
